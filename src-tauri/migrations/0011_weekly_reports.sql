...
-- 본문 정본은 vault/reports/<주 시작일>-week.md 파일. 이 테이블은 메타만 (daily_reports 와 같은 구조).
--
...
--
-- week_start 는 그 주의 시작일이다 — 요일 기준은 lib/date.ts 의 WEEK_STARTS_ON 하나 (0013).

CREATE TABLE weekly_reports (
    id            INTEGER PRIMARY KEY AUTOINCREMENT,
    week_start    TEXT    NOT NULL UNIQUE
                          CHECK (week_start GLOB '[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]'),
    file_path     TEXT    NOT NULL,              -- vault 기준 상대경로 'reports/<주 시작일>-week.md'
