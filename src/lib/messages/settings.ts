...
const ko = {
  ...
  "settings.prompts.deleteConfirm": "{name} 프롬프트를 삭제할까요?",
...
const en: Record<keyof typeof ko, string> = {
  ...
  "settings.ai.behaviorTitle": "Responses",
  ...
  "settings.prompts.deleteConfirm": "Delete the prompt {name}?",
