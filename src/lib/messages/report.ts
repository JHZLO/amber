...
const ko = {
  ...
  "report.stop": "중단",
  "report.stopHint": "생성 중인 AI 실행을 끝냅니다. 수집이 끝난 뒤부터 누를 수 있어요",
  // 주간 리포트 — 출력 형식은 사용자의 /Weekly Report 스킬 규약(노션 공유용)을 따른다
  "report.weekly.title": "주간 리포트",
  "report.weekly.busy": "주간 리포트 생성 중",
  "report.weekly.generate": "주간 정리",
  "report.weekly.summarizing": "한 주를 정리하는 중…",
  "report.weekly.copy": "원문 복사 (노션 붙여넣기용)",
  "report.weekly.raw": "마크다운 원문 보기",
  "report.weekly.coverage": "일간 리포트 {n}일치",
  "report.weekly.missingDays": "· 빠진 날 {n}일",
  "report.weekly.noSources": "이 주에는 일간 리포트가 없어요",
  "report.weekly.builtFrom": "일간 {n}일치로 정리",
  "report.weekly.currentWeek": "이번 주는 아직 진행 중이라 지금까지의 기록만 정리돼요.",
  "report.weekly.empty": "이 주에는 정리할 일간 리포트가 없어요. 먼저 하루 리포트를 만들어 주세요.",
  "report.weekly.futureNo": "아직 오지 않은 주예요",
  "report.weekly.regenTitle": "주간 리포트 다시 만들기",
  ...
  "report.weekly.nameHint":
    "주간 리포트 도메인 줄 끝에 '@이름' 으로 붙어요 (노션 공유 형식). 일간 리포트에는 안 쓰여요.",
...
const en: Record<keyof typeof ko, string> = {
  ...
  "report.stop": "Stop",
  "report.stopHint": "Ends the running AI call. Available once collection finishes",
  "report.weekly.title": "Weekly report",
  "report.weekly.busy": "Generating the weekly report",
  "report.weekly.generate": "Summarize week",
  "report.weekly.summarizing": "Summarizing the week…",
  "report.weekly.copy": "Copy markdown (for pasting into Notion)",
  "report.weekly.raw": "View raw markdown",
  "report.weekly.coverage": "{n} daily report(s)",
  "report.weekly.missingDays": "· {n} day(s) missing",
  "report.weekly.noSources": "No daily reports this week",
  "report.weekly.builtFrom": "Built from {n} daily report(s)",
  "report.weekly.currentWeek": "This week is still in progress, so only what has happened so far is included.",
  "report.weekly.empty": "There are no daily reports to summarize for this week. Create a daily report first.",
  "report.weekly.futureNo": "That week hasn't started yet",
  "report.weekly.regenTitle": "Regenerate weekly report",
  ...
  "report.weekly.nameHint":
    "Appended as '@name' to each domain line in the weekly report (the Notion sharing format). Not used in daily reports.",
