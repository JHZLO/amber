...
const ko = {
  ...
  "notes.spanAi.baseChanged": "실행을 시작한 뒤 노트가 바뀌었어요. 반영하면 그 사이 고친 내용이 실행 시점 본문으로 덮여요.",
  "notes.spanAi.composeBusy": "이 노트는 지금 AI가 전문을 쓰는 중이에요. 그게 끝나야 부분 수정을 시작할 수 있어요.",
  ...
  // 출력 상한 잘림 — 경고 + 이어서 쓰기
  "notes.ai.truncated": "출력이 모델의 길이 상한에서 잘렸어요. 끝부분이 끊겨 있을 수 있어요.",
  "notes.ai.continue": "이어서 쓰기",
  "notes.ai.continuing": "끊긴 곳부터 이어서 쓰는 중…",
  "notes.ai.continued": "출력이 길어 CLI 가 두 번에 나눠 썼고, 앱이 앞부분을 이어 붙였어요. 이어진 자리를 한 번 확인하세요.",
  ...
  "notes.ai.spanBusy": "이 노트는 지금 AI가 일부를 고치는 중이에요. 그게 끝나야 전문 작성을 시작할 수 있어요.",
  "notes.ai.bg.keep": "닫고 계속 쓰기",
  "notes.ai.bg.hint": "닫아도 계속 써요. 끝나면 노트 위에 알려 드릴게요.",
  "notes.ai.bg.running": "AI 가 이 노트를 쓰고 있어요",
  "notes.ai.bg.editing": "AI 가 이 노트의 일부를 고치고 있어요",
  "notes.ai.bg.open": "보기",
  "notes.ai.bg.ready": "AI 초안이 준비됐어요",
  "notes.ai.bg.editReady": "고쳐 쓴 부분이 준비됐어요",
...
const en: Record<keyof typeof ko, string> = {
  ...
  "notes.spanAi.baseChanged": "The note changed after this run started. Applying replaces it with the content as it was when the run began.",
  "notes.spanAi.composeBusy": "The AI is writing this whole note right now. Part edits can start once that finishes.",
  ...
  "notes.ai.truncated": "The output hit the model's length limit — the ending may be cut off.",
  "notes.ai.continue": "Continue writing",
  "notes.ai.continuing": "Continuing from where it stopped…",
  "notes.ai.continued": "The output was long enough that the CLI wrote it in two passes and the app stitched them together — check the seam.",
  ...
  "notes.ai.spanBusy": "The AI is editing part of this note right now. Whole-note writing can start once that finishes.",
  ...
  "notes.ai.bg.editing": "The AI is editing part of this note",
  "notes.ai.bg.open": "Open",
  "notes.ai.bg.ready": "Your AI draft is ready",
  "notes.ai.bg.editReady": "Your edited part is ready",
