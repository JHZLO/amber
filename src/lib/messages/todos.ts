...
const ko = {
  ...
  "todos.suggest.idle": "아직 안 훑었어요. 위 새로고침을 누르면 오늘 움직인 것(저장소, AI 세션)을 보고 목록에 없는 할 일을 골라 드려요.",
  "todos.suggest.none": "오늘 따로 챙길 건 없어 보여요.",
  "todos.suggest.nothingToRead":
    "오늘 움직인 게 아직 없어요. 설정 › 리포트에서 저장소와 AI 세션을 켜 두면 거기서 찾아 드려요.",
  ...
  "todos.suggest.src.activity": "오늘 움직임",
...
const en: Record<keyof typeof ko, string> = {
  ...
  "todos.suggest.idle": "Nothing looked at yet. Refresh above and what moved today - repositories, AI sessions - gets read for work that never made the list.",
  "todos.suggest.none": "Nothing stands out for today.",
  "todos.suggest.nothingToRead":
    "Nothing has moved today yet. Turn on repositories and AI sessions under Settings › Report and they get read here.",
  ...
  "todos.suggest.src.activity": "Today",
  ...
  "todos.row.park": "To Anytime - takes the date off",
