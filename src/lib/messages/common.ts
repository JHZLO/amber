...
const ko = {
  ...
  "common.err.nothingToSuggest": "고를 거리가 없어요 — 밀린 일도, 내려놓은 일도, 최근 기록도 비어 있어요.",
...
const en: Record<keyof typeof ko, string> = {
  ...
  "common.err.nothingToSuggest": "Nothing to go on - no overdue, nothing parked, no recent write-ups.",
