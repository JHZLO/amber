...
const ko = {
  ...
  "diagrams.db.hint.account": "비밀번호는 macOS 키체인에만 저장돼요 — 앱 DB·파일·로그에 남지 않아요. Amber 는 information_schema 만 읽으니 읽기 전용 계정을 권장해요.",
  "diagrams.db.test.idle": "아직 연결을 확인하지 않았어요",
  "diagrams.db.test.idleHint": "다음 단계로 넘어가려면 먼저 확인해야 해요.",
  "diagrams.db.test.testing": "확인하는 중…",
  "diagrams.db.test.ok": "연결됐어요",
  "diagrams.db.test.failed": "연결하지 못했어요",
  "diagrams.db.test.again": "다시 확인",
  ...
  "diagrams.db.tree.syncAll": "모든 스키마 동기화",
  "diagrams.db.tree.edit": "연결 편집",
  "diagrams.db.tree.disconnect": "연결 끊기",
  "diagrams.db.tree.openErd": "전체 ERD 열기",
  "diagrams.db.tree.generated": "생성됨",
  "diagrams.db.disconnect.title": "연결 끊기",
  "diagrams.db.disconnect.body": "연결을 끊어요. 저장된 접속 정보와 키체인의 비밀번호가 지워져요.",
  "diagrams.db.disconnect.keepNote": "폴더와 만들어진 ERD 는 그대로 남아 평범한 다이어그램이 돼요.",
  "diagrams.db.disconnect.deleteNote": "폴더와 그 안의 ERD 가 휴지통으로 함께 옮겨져요.",
  "diagrams.db.disconnect.alsoFiles": "폴더와 만들어진 ERD 도 함께 지우기",
  "diagrams.db.disconnect.confirm": "연결 끊기",
  "diagrams.db.disconnect.working": "끊는 중…",
...
const en: Record<keyof typeof ko, string> = {
  ...
  "diagrams.db.hint.account": "The password is stored only in the macOS Keychain — never in the app database, files, or logs. Amber reads only information_schema, so a read-only account is recommended.",
  "diagrams.db.test.idle": "Connection not checked yet",
  "diagrams.db.test.idleHint": "Check it before moving to the next step.",
  "diagrams.db.test.testing": "Checking…",
  "diagrams.db.test.ok": "Connected",
  "diagrams.db.test.failed": "Couldn\u2019t connect",
  "diagrams.db.test.again": "Check again",
  ...
  "diagrams.db.tree.syncAll": "Sync every schema",
  "diagrams.db.tree.edit": "Edit connection",
  "diagrams.db.tree.disconnect": "Disconnect",
  "diagrams.db.tree.openErd": "Open the full ERD",
  "diagrams.db.tree.generated": "generated",
  "diagrams.db.disconnect.title": "Disconnect",
  "diagrams.db.disconnect.body": "— disconnect it? The saved connection details and the Keychain password are removed.",
  "diagrams.db.disconnect.keepNote": "The folder and the ERDs stay, as ordinary diagrams.",
  "diagrams.db.disconnect.deleteNote": "The folder and the ERDs inside it move to the Trash too.",
  "diagrams.db.disconnect.alsoFiles": "Also delete the folder and the ERDs",
  "diagrams.db.disconnect.confirm": "Disconnect",
  "diagrams.db.disconnect.working": "Disconnecting…",
